                        ...
                        <div className="relative shadow-xl sm:rounded-2xl sm:overflow-hidden">
                            ...
                            <div className="relative px-4 py-16 sm:px-6 sm:py-24 lg:py-32 lg:px-8 flex flex-col items-center">
                                <h1 className="text-center text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl">
                                    ...
                                    <span className="block text-sky-400">sin dramas</span>
                                </h1>
                                    ...
                                    <form action="#" className="rounded-lg">
                                        <div className="sm:flex">
                                            ...
                                            <div className="">
                                                <button
                                                    type="submit"
                                                    className="block w-full py-3 px-6 rounded-lg sm:rounded-none sm:rounded-r-lg shadow bg-sky-500 text-white font-semibold hover:bg-sky-600 transition-all duration-10"
                                                >
                                                    Buscar
                                                </button>
                                            </div>
